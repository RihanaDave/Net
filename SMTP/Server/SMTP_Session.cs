...
// REMOVE ME:
        ...
        private byte[] CreateReceivedHeader()
        {
            ...
            */
            ...
            Pendar.Mail.Mail_h_Received received = new Pendar.Mail.Mail_h_Received(this.EhloHost,Net_Utils.GetLocalHostName(this.LocalHostName),DateTime.Now);
            received.From_TcpInfo = new Pendar.Mail.Mail_t_TcpInfo(this.RemoteEndPoint.Address,null);
            received.Via = "TCP";
