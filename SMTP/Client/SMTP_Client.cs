...
namespace Pendar.SMTP.Client
{
	...
	///  using Pendar.SMTP.Client; 
	/// */
    /// 
    /// // You can send any valid SMTP message here, from disk,memory, ... or
    /// // you can use Pendar.Mail classes to compose valid SMTP mail message.
    /// 
    ...
    public class SMTP_Client : TCP_Client
    {
        ...
        public static void QuickSend(Pendar.Mime.Mime message)
        {
            if(message == null){
