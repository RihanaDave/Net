...
namespace Pendar.RTP.Debug
{
    ...
    public class wfrm_RTP_Debug : Form
    {
        ...
        public wfrm_RTP_Debug(RTP_MultimediaSession session)
        {
            ...
            m_pSession.Error += new EventHandler<Pendar.ExceptionEventArgs>(m_pSession_Error);
            m_pSession.SessionCreated += new EventHandler<Pendar.EventArgs<RTP_Session>>(m_pSession_SessionCreated);
        ...
        private void m_pSession_Error(object sender,Pendar.ExceptionEventArgs e)
        {
            if(m_IsDisposed){
                return;
            }
